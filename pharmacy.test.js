import { Drug, Pharmacy, PharmacyRefactored } from "./pharmacy";
import { createLog } from "./createLog";
import fs from "fs";

function testsForPharmacy(createPharmacy) {
  return () => {
...
describe("All type of pharmacies", () => {
  ...
  describe("Pharmacy", testsForPharmacy(createPharmacyNormal));

  const createPharmacyRefactored = (drugs) => new PharmacyRefactored(drugs);
  describe("PharmacyRefactored", testsForPharmacy(createPharmacyRefactored));
});
