import { Drug, PharmacyRefactored } from "./pharmacy";
import { createLog } from "./index";
import fs from "fs";

describe("PharmacyRefactored", () => {
  it("should decrease the benefit and expiresIn", () => {
    const pharmacy = new PharmacyRefactored([new Drug("test", 2, 3)]);
  ...
  it("should decrease the benefit twice as fast after expiration date", () => {
    ...
    const pharmacy = new PharmacyRefactored([drug]);
  ...
  it("should produce the same output as the one stored in output-model.json", () => {
    ...
    const pharmacy = new PharmacyRefactored(drugs);
